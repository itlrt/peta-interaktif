...
export default function EditUserPage() {
  ...
  const validateForm = (): boolean => {
    ...
    // Validate password only if changePassword is true
    if (changePassword) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Pengguna berhasil diperbarui! (simulasi)")
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold">Edit Pengguna: {userData.name}</h1>
      </div>
